...
public class Magic
{
    ...
    public static Item cosmicRune = new Item("CosmicRune", "src/skills/Magic/Images/CosmicRune");
        ...
        try
        {
            ...
            switch(input)
            {
                case "1":
                    ...
                    Spell    = "src/skills/Magic/Images/Spells/HighAlch.png";
                    highAlch = true;
                    break;
            ...
            switch(input)
            {
                case "1":
                    ...
                    anItem = new Item("EmeraldRing", "src/skills/Magic/Images/EmeraldRing");
                    Spell = "src/skills/Magic/Images/Spells/EnchantEmerald.png";
                    break;

                case "2":
                    System.out.println("Using ruby amulet");
                    anItem = new Item("RubyAmulet", "src/skills/Magic/Images/RubyAmulet");
                    Spell = "src/skills/Magic/Images/Spells/EnchantRuby.png";
                    break;
            }
