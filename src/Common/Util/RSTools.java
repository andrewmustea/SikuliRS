...
public class RSTools {
	...
	public static void openBank() throws InterruptedException, FindFailed
	{
		while(Coordinates.Bankbox.exists("src/Common/Images/BankOfGlielinor.png") == null)
		{
			...
			Match bankMatch = Coordinates.Bankbox.exists("src/Common/Images/BankBanker.png");
			if (bankMatch != null)
			{
...
//		}
	...
	public static boolean withdrawFromBank(String inBankPicture, String inInventoryPicture, int inWithdrawAmount) throws FindFailed, InterruptedException
	{
		...
		Match bankItemMatch = Coordinates.Bankbox.exists(new Pattern(inBankPicture).exact());
	...
	public static void clickOnAllInInventory(String inPicture) throws InterruptedException, IOException
	{
		try 
		{
			Iterator<Match> it = Coordinates.Inventory.findAll(inPicture);
